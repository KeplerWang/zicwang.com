...
You can add posts by creating a new markdown document in the `contents/blog` path.

### 1-1. Post file structure

There are two ways to add a new document. The first is to create a markdown file for a single document without a directory. If you are writing about JavaScript, you can create a `about-javascript.md` file in the `contents/blog` directory.
...
If you have written a Frontmatter, you can write your markdown document under it. Gatsbyjs supports most Markdown syntax. To learn more about Markdown syntax, see the [Mastering Markdown](https://guides.github.com/features/mastering-markdown/) documentation on GitHub.
...
The current document is also set in a series called `Getting started your blog with Gatsbyjs`.
